...
import { KnowledgeBlockNode } from "./block-node";
...
// 커스텀 노드/엣지 타입 (any로 타입 이슈 회피)
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const nodeTypes: any = {
  knowledgeBlock: KnowledgeBlockNode,
};
...
function BlockCanvasInner({
  ...
  const createBlock = useCallback(
    ...
    [nodes.length, topicClusterId, setNodes, handleDeleteBlock, handleDuplicateBlock, startConnecting, handleCollapseBlock, handlePinBlock]
  );
  ...
  }, [reactFlowInstance, editingBlockId, selectedBlockId, handleDeleteBlock, handleDuplicateBlock]);
  ...
  const handleSlashCommand = useCallback(
    (commandId: string) => {
      ...
      // TODO: 다른 액션들 (merge, move, synthesize)
